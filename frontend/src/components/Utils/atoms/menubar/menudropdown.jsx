...
export function NavbarMenuDropdown({ children, trigger, tabIndex }) {
  return (
    <MenuDropdown
      triggerClassName="nodrag flex cursor-pointer select-none items-center justify-between gap-1 rounded-md py-1 px-2 text-xs font-semibold leading-none text-setta-700 outline-hidden transition-colors duration-150 hover:bg-setta-100 focus-visible:ring-2 dark:text-setta-200 dark:hover:bg-setta-800"
