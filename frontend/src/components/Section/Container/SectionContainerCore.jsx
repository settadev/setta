...
function _SectionContainerCore({ sectionId, viewingEditingMode }) {
  ...
  return (
    <section
      className={`group/card-section transition-radius ${!positionAndSizeLocked ? "rounded-xl border-white dark:border-setta-700" : "rounded-xs border-setta-400/90 dark:border-setta-800"} border  bg-white  dark:bg-setta-925 ${boxShadow} dndline w-min outline outline-4 ${outlineColor} `}
