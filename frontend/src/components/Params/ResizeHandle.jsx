...
export function ResizeHandle({ showResizeHandle, onMouseDown }) {
  return (
    <div className="section-center relative mx-auto h-[90%] w-0.5 rounded-xs group-hover/arg-group:bg-setta-500/15">
      {showResizeHandle && (
        <div
        ...
        >
          <div className="h-[calc(100%-4px)] w-1.5 rounded-sm bg-transparent hover:bg-blue-500! group-hover/resize:bg-setta-200 dark:group-hover/resize:bg-setta-500" />
        </div>
      )}
    </div>
  );
