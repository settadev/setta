...
function CoreCodeArea({ sectionId, language, completionsFn, keywordStylizer }) {
  ...
  return (
    <article
      ref={wrapperRef}
      className={`${NO_PAN_CLASS_NAME} ${SETTA_PREVENT_SECTION_ACTIVE_CSS} nodrag section-full-no-title cursor-auto rounded-lg focus:bg-blue-200/70 focus:outline-hidden dark:focus:bg-blue-950/70 **:outline-0! focus:[&_.cm-activeLineGutter]:bg-transparent! focus:[&_.cm-activeLine]:bg-transparent! focus:[&_.cm-gutters]:bg-transparent! ${overflow} ${nowheel}`}
      tabIndex="0"
